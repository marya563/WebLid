...
*/
        ...
        $headers = 'alalemjid284@gmail.com ';
...
<head>
    ...
    <!-- Site Metas -->
    <title>BOOMER'Z Inscription</title>
    ...
    <div class="about-section-box">
            <div class="col-lg-6 col-md-6 col-sm-12 ">
                <div class="inner-column">
                    <h1 style="color:   #61e9f4;">Bienvenue chez BOOMER'Z </h1>
                </div>
            </div>
    </div>
        ...
        <div class="login-form">
            <div class="login-wrap">
                <a class="navbar-brand">
                    <img src="../Views/images/boomerz.png" height="200" width="250">
                </a>
